...
Project Highlights: Price prediction using Linear Regression, feature analysis of car attributes, handling categorical data using encoding, data visualization using graphs, model training and performance evaluation

Outcome: Built a machine learning model to predict car prices and gained hands-on experience in data preprocessing, visualization, and regression techniques
